...
- xref:../global_hub/global_hub_import_hub_default.adoc#global-hub-importing-managed-hub-which-has-local-cluster-enabled[Importing a managed hub cluster which has local-cluster enabled]
